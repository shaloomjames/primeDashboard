...
const ShowAttendance = () => {
  ...
  useEffect(() => {
    if (search === "") {
      ...
      setId(null);
      setAttendanceReport(null); // Clear the report
      return;
    }
    ...
    setFilteredRecords(filteredBySearch);
    ...
    if (
      ...
      filteredBySearch.every(
        (record) =>
          record.employee.employeeId === filteredBySearch[0].employee.employeeId
      )
    ) {
      setId(filteredBySearch[0].employee._id);
    } else {
