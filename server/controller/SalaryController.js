  ...
  try {
    ...
    <table role="presentation" style="width: 100%; border-collapse: collapse; font-family: Arial, sans-serif; color: #333333;">
                            ...
                            <table role="presentation" style="width: 100%; border-collapse: collapse; border-spacing: 0; font-size: 14px;">
                                ...
                                <tbody>
                                    <tr>
                                        ...
                                        <td style="padding: 8px; border-bottom: 1px solid #e0e0e0;">${employeeId}</td>
                                    </tr>
                                    <tr>
                                    ...
                                    <tr>
                                        ...
                                        <td style="padding: 8px; border-bottom: 1px solid #e0e0e0;">${salaryPerDay}</td>
                                    </tr>
                                    <tr>
                                        <td style="padding: 8px; border-bottom: 1px solid #e0e0e0;">Allowances</td>
                                        <td style="padding: 8px; border-bottom: 1px solid #e0e0e0;">${allowances} (${totalAllowanceAmount})</td>
                                    </tr>
                                    <tr>
                                        <td style="padding: 8px; border-bottom: 1px solid #e0e0e0;">Deductions</td>
                                        <td style="padding: 8px; border-bottom: 1px solid #e0e0e0;">${deductions} (${totalDeduction})</td>
                                    </tr>
                                    <tr>
                                        <td style="padding: 8px; border-bottom: 1px solid #004080; font-weight: bold;">Net Salary</td>
                                        <td style="padding: 8px; border-bottom: 1px solid #004080; color: #28a745; font-weight: bold;">${netSalary}</td>
                                    </tr>
                                </tbody>
                            </table>
                        </td>
      ...
      await SendMail(
        ...
        `Dear ${employeeName}, find your detailed salary breakdown enclosed.`,
        emailHTML
      );
    } catch (err) {
